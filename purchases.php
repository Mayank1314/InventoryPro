...
if(isset($_GET['search']) && $_GET['search']!="")
{
    ...
    $sql .= " WHERE suppliers.supplier_name LIKE '%$search%'
...
<a href="edit_purchase.php?id=<?php echo $row['id']; ?>" class="btn btn-success btn-sm">
...
Click <strong>Add Purchase</strong> to create your first purchase.
